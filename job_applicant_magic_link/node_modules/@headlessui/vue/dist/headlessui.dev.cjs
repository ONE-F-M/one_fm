...
var ComboboxOption = (0, import_vue11.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let selected = (0, import_vue11.computed)(
      () => match(api.mode.value, {
        [0 /* Single */]: () => api.compare((0, import_vue11.toRaw)(api.value.value), (0, import_vue11.toRaw)(props.value)),
        [1 /* Multi */]: () => (0, import_vue11.toRaw)(api.value.value).some(
          (value) => api.compare((0, import_vue11.toRaw)(value), (0, import_vue11.toRaw)(props.value))
        )
      })
    );
...
var Dialog = (0, import_vue23.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let dialogState = (0, import_vue23.computed)(
    ...
    let isClosing = (0, import_vue23.computed)(
    ...
    let resolveRootOfMainTreeNode = (0, import_vue23.computed)(() => {
      var _a2, _b, _c;
    ...
    let inertParentDialogs = (0, import_vue23.computed)(() => {
      if (hasNestedDialogs.value)
        return true;
      return enabled.value;
    });
    let resolveRootOfParentDialog = (0, import_vue23.computed)(() => {
      var _a2, _b, _c;
      return (_c = Array.from(
        (_b = (_a2 = ownerDocument.value) == null ? void 0 : _a2.querySelectorAll("[data-headlessui-portal]")) != null ? _b : []
      ).find((root) => root.contains(dom(mainTreeNode)) && root instanceof HTMLElement)) != null ? _c : null;
    });
    ...
    function resolveRootContainers() {
      ...
      let rootContainers = Array.from(
        (_b = (_a2 = ownerDocument.value) == null ? void 0 : _a2.querySelectorAll("html > *, body > *, [data-headlessui-portal]")) != null ? _b : []
      ).filter((container) => {
...
var Disclosure = (0, import_vue24.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    let disclosureState = (0, import_vue24.ref)(
...
var DisclosureButton = (0, import_vue24.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let isWithinPanel = (0, import_vue24.computed)(
...
var Listbox = (0, import_vue25.defineComponent)({
  ...
  setup(props, { slots, attrs, emit }) {
    ...
    let activationTrigger = (0, import_vue25.ref)(
      1 /* Other */
    );
    function adjustOrderedState(adjustment = (i) => i) {
      let currentActiveOption = activeOptionIndex.value !== null ? options.value[activeOptionIndex.value] : null;
    ...
    let [value, theirOnChange] = useControllable(
      ...
      (value2) => emit("update:modelValue", value2),
      (0, import_vue25.computed)(() => props.defaultValue)
    );
    let api = {
      listboxState,
      value,
...
var ListboxOption = (0, import_vue25.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let selected = (0, import_vue25.computed)(
      () => match(api.mode.value, {
        [0 /* Single */]: () => api.compare((0, import_vue25.toRaw)(api.value.value), (0, import_vue25.toRaw)(props.value)),
        [1 /* Multi */]: () => (0, import_vue25.toRaw)(api.value.value).some(
          (value) => api.compare((0, import_vue25.toRaw)(value), (0, import_vue25.toRaw)(props.value))
        )
      })
    );
      ...
      return match(api.mode.value, {
        [1 /* Multi */]: () => {
          ...
          return ((_a = api.options.value.find(
            (option) => currentValues.some((value) => api.compare((0, import_vue25.toRaw)(value), (0, import_vue25.toRaw)(option.dataRef.value)))
...
var Menu = (0, import_vue26.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    ...
    let activationTrigger = (0, import_vue26.ref)(
      1 /* Other */
    );
    function adjustOrderedState(adjustment = (i) => i) {
...
var Label = (0, import_vue28.defineComponent)({
  ...
  setup(myProps, { slots, attrs }) {
    ...
    return () => {
      ...
      let ourProps = {
        ...Object.entries(props).reduce(
          (acc, [key, value]) => Object.assign(acc, { [key]: (0, import_vue28.unref)(value) }),
          {}
        ),
        id: id2
      };
...
var RadioGroup = (0, import_vue29.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let api = {
      ...
      firstOption: (0, import_vue29.computed)(
      ...
      containsCheckedOption: (0, import_vue29.computed)(
        () => options.value.some(
          (option) => api.compare((0, import_vue29.toRaw)(option.propsRef.value), (0, import_vue29.toRaw)(props.modelValue))
        )
      ),
      compare(a, z) {
        if (typeof props.by === "string") {
      ...
      change(nextValue) {
        ...
        let nextOption = (_a = options.value.find(
          (option) => api.compare((0, import_vue29.toRaw)(option.propsRef.value), (0, import_vue29.toRaw)(nextValue))
...
var RadioGroupOption = (0, import_vue29.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let element = (0, import_vue29.computed)(() => dom(optionRef));
    (0, import_vue29.onMounted)(() => api.registerOption({ id: props.id, element, propsRef }));
...
var SwitchGroup = (0, import_vue30.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    ...
    let labelledby = useLabels({
      name: "SwitchLabel",
      props: {
        htmlFor: (0, import_vue30.computed)(() => {
          var _a;
...
var Switch = (0, import_vue30.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let [checked, theirOnChange] = useControllable(
      ...
      (0, import_vue30.computed)(() => props.defaultChecked)
    );
    function toggle() {
    ...
    return () => {
      ...
      return (0, import_vue30.h)(import_vue30.Fragment, [
        name != null && checked.value != null ? (0, import_vue30.h)(
          Hidden,
          compact({
            features: 4 /* Hidden */,
            as: "input",
...
var TabGroup = (0, import_vue32.defineComponent)({
  ...
  setup(props, { slots, attrs, emit }) {
    var _a;
    let selectedIndex = (0, import_vue32.ref)(
    ...
    let realSelectedIndex = (0, import_vue32.computed)(
    ...
    (0, import_vue32.provide)(
      TabsSSRContext,
      (0, import_vue32.computed)(() => mounted.value ? null : SSRCounter.value)
    );
    ...
    return () => {
      ...
      let theirProps = {
        ...
        ...appear.value && show.value && env.isServer ? {
          ...
          class: (0, import_vue33.normalizeClass)([
            attrs.class,
