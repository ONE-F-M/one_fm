...
def execute():
	"""Create Process Task and Assignment Rule for Subcontractor Exit - GSD Supervisor."""
	task_data = {
		"process_name": "Subcontractor",
		"erp_document": "Subcontractor Exit",
		"task_description": "Assigning GSD Supervisor",
	...
	create_assignment_rule(
		get_assignment_rule_json_file("subcontractor_exit_gsd_supervisor.json"),
