...
def execute():
	"""Create Process Task and Assignment Rule for Subcontractor Exit - HR Offboarding Officer."""
	task_data = {
		"process_name": "Subcontractor",
		"erp_document": "Subcontractor Exit",
		"task_description": "Assigning HR Offboarding Officer",
	...
	create_assignment_rule(
		get_assignment_rule_json_file("subcontractor_exit_offboarding_officer.json"),
