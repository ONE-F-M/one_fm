...
def execute():
	"""Create Process Task and Assignment Rule for Subcontractor Exit - Operations Manager."""
	task_data = {
		"process_name": "Subcontractor",
		"erp_document": "Subcontractor Exit",
		"task_description": "Assigning Operations Manager",
		"employee": "HR-EMP-02771",
	...
	create_assignment_rule(
		get_assignment_rule_json_file("subcontractor_exit_operations_manager.json"),
