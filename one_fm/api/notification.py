...
from one_fm.processor import is_user_id_not_company_prefred_email_in_employee
...
def after_insert(doc):
	...
	if is_email_notifications_enabled_for_type(doc.for_user, doc.type) and is_user_id_not_company_prefred_email_in_employee(doc.for_user) :
		try:
