...
def process_rambo_shift_assignment(schedules, date):
	...
	For each Rambo Employee Schedule row:
	  ...
	  3. Skip if a Shift Assignment already exists for this employee_schedule
	  4. Otherwise, create and submit a new Shift Assignment
	"""
	...
	for schedule in schedules:
		try:
			...
			# Guard: skip if Shift Assignment already exists for this Employee Schedule
