...
required_apps = ['frappe', 'erpnext', "helpdesk", "hrms", "payments", "wiki", "twilio-integration", "https://github.com/ONE-F-M/one_wiki.git", "https://github.com/ONE-F-M/password_management.git"]
