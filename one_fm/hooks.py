...
scheduler_events = {
	"daily": [
        ...
        'one_fm.utils.send_pending_alm_checkin_notifications',
...
after_migrate = [
    ...
    # After sync_fixtures, which restores the stale ERF field_order property setter.
    "one_fm.after_migrate.execute.drop_erf_field_order_property_setter"
]
