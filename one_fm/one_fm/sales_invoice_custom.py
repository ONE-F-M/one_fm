...
def create_sales_invoice():
    ...
    contacts_list = frappe.db.sql("""select name,client,project,price_list,invoice_frequency,due_date,frequency,start_date 
    ...
    for item in contacts_list:
        ...
        if item.invoice_frequency == 'Monthly':
            ...
            contract_item_list = frappe.db.sql("""select ci.name,ci.item_code,ci.head_count as qty,shift_hours,unit_rate
