...
function load_js(page){
	...
	if($('.layoutSidenav_content').attr('data-view') == 'roster'){ 
		...
		$("#weekviewclick").click(function () {
			...
			$('.postWeek').addClass("d-none");
			$('#partialcalenderview').append(frappe.render_template('roster_week_view'));
			isMonth = 0;
		});
		//tab click for week view data function call
		...
		page.rosterWeek = get_roster_data;
		...
		$(`input[name="selectallcheckbox"]`).on("change", function () {
			...
			if ($(this).is(":checked")) {
				...
				$(this).parent().parent().parent().children("td").children().not("label").not(".bluebox").not(".greybox").not(".purplebox").not(".borderbox").addClass("selectclass");
				var month = calendarSettings1.date.format("MM");
				var year = calendarSettings1.date.format("YYYY");
				$(".filterhideshow").removeClass("d-none");
				$("#txtpoststartdate").val("01/" + month + "/" + year);
				$("#txtpostenddate").val("");

			}
			else {
				$(this).parent().parent().parent().children("td").children().not("label").not(".bluebox").not(".greybox").not(".purplebox").not(".borderbox").removeClass("selectclass");
				$(".filterhideshow").addClass("d-none");
    ...
    $(function () {
        var datePicker = $("#datepickeron").datepicker({
            autoclose: true,
			todayHighlight: true,
			language: 'en',
            format: "dd/mm/yyyy",
            ...
            var getwidth = $("#datepickeron").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#addpostmodal").on(
    ...
    $(function () {
        var datePicker = $("#datepickerafter").datepicker({
            autoclose: true,
			todayHighlight: true,
			language: 'en',
            format: "dd/mm/yyyy",
            ...
            var getwidth = $("#datepickerafter").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#addpostmodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickerafter").datepicker("place");
                }, 0);
            }
        );
    ...
    $(function () {
        var datePicker = $("#datepickerfromdate").datepicker({
            autoclose: true,
			language: 'en',
            startDate: new Date(),
            todayHighlight: true,
            ...
            var getwidth = $("#datepickerfromdate").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#addpostmodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickerfromdate").datepicker("place");
                }, 0);
            }
        );
    ...
    $(function () {
        var datePicker = $("#datepickertodate").datepicker({
            autoclose: true,
			language: 'en',
            todayHighlight: true,
            startDate: new Date(),
            ...
            var getwidth = $("#datepickertodate").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#addpostmodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickertodate").datepicker("place");
                }, 0);
            }
        );
    });
    $(function () {
        var datePicker = $("#datepickercancelfromdate").datepicker({
            autoclose: true,
			language: 'en',
            startDate: new Date(),
            todayHighlight: true,
            ...
            var getwidth = $("#datepickercancelfromdate").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#addpostmodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickercancelfromdate").datepicker("place");
                }, 0);
            }
        );
    });
    ...
    $(function () {
        var datePicker = $("#datepickerRetrivefromdate").datepicker({
            autoclose: true,
			language: 'en',
            startDate: new Date(),
            todayHighlight: true,
            ...
            var getwidth = $("#datepickerRetrivefromdate").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#addpostmodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickerRetrivefromdate").datepicker("place");
                }, 0);
            }
        );
    });

    $(`input[name="txtnaverradio"]`).click(function () {
        var radioValue = $(this).val();
        if (radioValue === "0") {
            $(".oneventdate").addClass("d-none");
            $(".aftereventdate").addClass("d-none");
        }
        else if (radioValue === "1") {
            $(".oneventdate").removeClass("d-none");
            $(".aftereventdate").addClass("d-none");
        }
        else {
            $(".oneventdate").addClass("d-none");
            $(".aftereventdate").removeClass("d-none");
        }
    });
    $("#postcalendertype").change(function () {
        var getreccuval1 = $(this).children("option:selected").val();
        if (getreccuval1 === "0") {
            $(".postoffdiv").removeClass("d-none");
            $(".suspendpostdiv").addClass("d-none");
            $(".cancelpostcalenderdiv").addClass("d-none");
        }
        else if (getreccuval1 === "1") {
            $(".postoffdiv").addClass("d-none");
            $(".suspendpostdiv").removeClass("d-none");
            $(".cancelpostcalenderdiv").addClass("d-none");
        }
        else if (getreccuval1 === "2") {
            $(".postoffdiv").addClass("d-none");
            $(".suspendpostdiv").addClass("d-none");
            $(".cancelpostcalenderdiv").removeClass("d-none");
        }
        else if (getreccuval1 === "3") {
            $(".postoffdiv").addClass("d-none");
            $(".suspendpostdiv").addClass("d-none");
            $(".cancelpostcalenderdiv").removeClass("d-none");
        }
    ...
    $("#postcalenderrepeatpost").change(function () {
        var getreccuval = $(this).children("option:selected").val();
        if (getreccuval === "6") {
            $(".customreccurdiv").removeClass("d-none");
        }
        else {
            $(".customreccurdiv").addClass("d-none");
        }
    });
    //for dayoff modal
    $(`input[name="txtendradio"]`).click(function () {
        var dayoffradiovalue = $(this).val();
        if (dayoffradiovalue === "1") {
            $(".selecteventblock ").addClass("d-none");
            $(".selectdateblock").addClass("d-none");
        }
        else if (dayoffradiovalue === "2") {
            $(".selecteventblock").removeClass("d-none");
            $(".selectdateblock").addClass("d-none");
        }
        else {
            $(".selecteventblock").addClass("d-none");
            $(".selectdateblock").removeClass("d-none");
        }
    });
    $(`input[name="txtinputunassignradio"]`).click(function () {
        var unassignradiovalue = $(this).val();
        if (unassignradiovalue === "1") {
            $(".unassigndateblock ").addClass("d-none");

        }
        else {
            $(".unassigndateblock").removeClass("d-none");

        }
    });
    $(function () {
        var datePicker = $("#datepickerend").datepicker({
            autoclose: true,
			language: 'en',
            todayHighlight: true,
            format: "dd/mm/yyyy",
            ...
            var getwidth = $("#datepickerend").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#dayoffmodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickerend").datepicker("place");
                }, 0);
            }
        );

    });
    //date picker for modal popup
    $(function () {
        var datePicker = $("#leavedatepicker").datepicker({
            autoclose: true,
			language: 'en',
            todayHighlight: true,
            format: "dd/mm/yyyy",
            ...
            var getwidth = $("#leavedatepicker").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#leaveabsentmodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#leavedatepicker").datepicker("place");
                }, 0);
            }
        );
    });
    $(function () {
        var datePicker = $("#enddatepicker").datepicker({
            autoclose: true,
			language: 'en',
            todayHighlight: true,
            format: "dd/mm/yyyy",
            ...
            var getwidth = $("#enddatepicker").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#leaveabsentmodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#enddatepicker").datepicker("place");
                }, 0);
            }
        );
    });
    $(function () {
        var datePicker = $("#datepickerpoststartdate").datepicker({
            autoclose: true,
			language: 'en',
            todayHighlight: true,
            format: "dd/mm/yyyy",
            ...
            var getwidth = $("#datepickerpoststartdate").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#assignchangemodal").on(
            "DOMMouseScroll mousewheel scroll",
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickerpoststartdate").datepicker("place");
                }, 0);
            }
        );
    });
    $(function () {
        var datePicker = $("#datepickerpostenddate").datepicker({
            autoclose: true,
			language: 'en',
            todayHighlight: true,
            format: "dd/mm/yyyy",
            ...
            var getwidth = $("#datepickerpostenddate").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#assignchangemodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickerpostenddate").datepicker("place");
                }, 0);
            }
        );
    });
    $(function () {
        var datePicker = $("#datepickerunassignstartdate").datepicker({
            autoclose: true,
			language: 'en',
            todayHighlight: true,
            format: "dd/mm/yyyy",
            ...
            var getwidth = $("#datepickerunassignstartdate").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#unassignchangemodal ").on(
            "DOMMouseScroll mousewheel scroll",
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickerunassignstartdate").datepicker("place");
                }, 0);
            }
        );
    });
    $(function () {
        var datePicker = $("#datepickerunassigndate").datepicker({
            autoclose: true,
			language: 'en',
            todayHighlight: true,
            format: "dd/mm/yyyy",
            ...
            var getwidth = $("#datepickerunassigndate").width();
            $(".datepicker-dropdown").css("width", getwidth);
        });
        var t;
        $("#unassignchangemodal").on(
            ...
            function () {
                window.clearTimeout(t);
                t = window.setTimeout(function () {
                    $("#datepickerunassigndate").datepicker("place");
                }, 0);
            }
        );
    });
	...
	$(".clickablerow").click(function () {
		...
		if ($(".clickablerow").parent().next().not(".show")) {
...
function get_roster_data(page){
	...
	.then(res => {
		...
		for(post_type_name in post_types_data){
			...
			$('.rosterMonth').find(`#calenderviewtable tbody tr[data-name="${post_types_data[post_type_name][i]['post_type']}"]`).append(`<td></td>`);
		}
		let emp_row_wrapper = `
			...
			<tr data-name="${employee_key}">
				<td>
					...
					<label class="checkboxcontainer simplecheckbox">
						<span class="lightgrey font16 customfontweight fontw400">${employee_key}</span>
				...
				if(name){
					...
					<td>
						<div class="${moment().isBefore(moment(date)) ? 'hoverselectclass' : 'forbidden'} tablebox darkblackox d-flex justify-content-center align-items-center so"
							...
							data-data="${start_date.format('YYYY-MM-DD')}"
							data-post="${post_name}"
						</div>
					</td>`;
				}
...
function staff_edit_dialog(){
	...
	let d = new frappe.ui.Dialog({
		...
		'fields': [
			...
			{'fieldname': 'assign_date', 'fieldtype': 'Date', 'default': frappe.datetime.nowdate(), 'depends_on': "eval:this.get_value('assign_from') == 'Date'"}
		],
