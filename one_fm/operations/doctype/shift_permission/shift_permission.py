...
def create_employee_checkin_for_shift_permission(shift_permission):
	...
	try:
		if not frappe.db.get_single_value("HR and Payroll Additional Settings", 'validate_shift_permission_on_employee_checkin')\
			...
			employee_checkin.date = shift_details.start_date if shift_permission.log_type=='IN' else shift_details.end_datetime
			employee_checkin.shift_actual_start = shift_details.start_datetime
			employee_checkin.shift_actual_end = shift_details.end_datetime
