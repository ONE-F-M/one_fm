...
@frappe.whitelist()
def log_pivotal_tracker(name, description):
    """
        Update HD Ticket Doctype with payload from Pivotal Tracker
    """
    try:
        if description:
        ...
        if pivotal_tracker.active:
            ...
            if(req.status_code==200):
                ...
                doc.db_set('custom_development_story_ticket', f"{pivotal_tracker.url}/n/projects/{project_id}/stories/{response_data.id}")
