...
career_history = Class.extend({
    ...
    set_promotion_section_html: function (company_no, promotion_no) {
        var next_promotion_details_html = `
        <div class="mx-auto col-lg-12 col-md-12 mb-12 promotion_section_${company_no}${promotion_no}">
    ...
    on_change_still_working_on_same_company: function (company_no) {
        ...
        $(".still_working_on_same_company_" + (company_no.toString())).on("change", function () {
            ...
            if (still_working == 1) {
                var reason_why_leave_job_html = `
                <div class="mx-auto col-lg-12 col-md-12 reason_why_leave_job_${company_no}">
    ...
    are_you_still_working_html: function (company_no) {
        var are_you_still_working_html = `
        <div class="row mx-auto col-lg-12 col-md-12 mb-3 are_you_still_working_${company_no}">
    ...
    when_did_you_left_the_company: function (company_no) {
        var when_did_you_left_the_company_html = `
        <div class="row mx-auto col-lg-12 col-md-12 mt-5 mb-12 when_did_you_left_${company_no}">
