...
from erpnext.payroll.doctype.payroll_entry.payroll_entry import PayrollEntry, get_emp_list
...
from one_fm.api.doc_methods.payroll_entry import validate_employee_attendance, get_count_holidays_of_employee, get_count_employee_attendance, get_emp_lists
...
PayrollEntry.get_emp_list = get_emp_lists
