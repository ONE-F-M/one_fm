...
from one_fm.api.doc_methods.payroll_entry import validate_employee_attendance, get_count_holidays_of_employee, get_count_employee_attendance, fill_employee_details, create_salary_slips_for_employees
...
PayrollEntry.create_salary_slips_for_employees = create_salary_slips_for_employees
