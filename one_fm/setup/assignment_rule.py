...
def create_assignment_rules():
	...
	create_assignment_rule(get_assignment_rule_json_file("accommodation_leave_movement_site_supervisor.json"))
	create_assignment_rule(get_assignment_rule_json_file("accommodation_leave_movement_site_supervisor_checkin.json"))
...
def delete_assignment_rules():
	...
	delete_assignment_rule(get_assignment_rule_json_file("accommodation_leave_movement_site_supervisor.json"))
	delete_assignment_rule(get_assignment_rule_json_file("accommodation_leave_movement_site_supervisor_checkin.json"))
