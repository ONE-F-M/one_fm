...
from .utils import create_assignment_rule

def execute():
    assignment_rule_data = {
            "assign_condition": "workflow_state == \"Pending Onboarding Officer\" ",
            "assignment_days": [
                    {
                        "day": "Monday",
                        "parent": "Subcontract Staff Shortlist",
                    ...
                    "users": [
                    {
                        ...
                        "parentfield": "users",
                        "parenttype": "Assignment Rule",
                        "user": "i.khot@one-fm.com"
                    }
            ]
    }
    create_assignment_rule(assignment_rule_data=assignment_rule_data)